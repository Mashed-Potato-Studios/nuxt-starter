  ...
  <section class="bg-white dark:bg-gray-900">
    <div class="container flex items-center justify-center min-h-screen px-6 mx-auto">
        <form class="w-full max-w-md">
            <img class="w-auto h-7 sm:h-8" src="https://avatars.githubusercontent.com/u/123331606?s=200&v=4" alt="">

            <h1 class="mt-3 text-2xl font-semibold text-gray-800 capitalize sm:text-3xl dark:text-white">Signin</h1>
            ...
            <div class="relative flex items-center mt-8">
                ...
                <input type="email" class="block w-full py-3 text-gray-700 bg-white border rounded-lg px-11 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Email address" v-model="email">
            </div>
            ...
            <div class="relative flex items-center mt-4">
                ...
                <input type="password" class="block w-full px-10 py-3 text-gray-700 bg-white border rounded-lg dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Password" v-model="password">
            </div>
            ...
            <div class="mt-6">
                ...
                <div class="mt-6 text-center ">
                    <NuxtLink to="register" class="text-sm text-blue-500 hover:underline dark:text-blue-400">
